...
keymap = [
	...
	{ keys = [ "ctrl+d" ],		command = "new_tab ~/Downloads" },
	...
	{ keys = [ "alt+k" ],		command = "cursor_move_page_up 0.5" },
	{ keys = [ "alt+j" ], 		command = "cursor_move_page_down 0.5" },
	...
	{ keys = [ "g", "h" ],		command = "cd ~/" },
	{ keys = [ "g", "m" ],		command = "cd /run/media" },
	{ keys = [ "g", "s" ],		command = "cd ~/sandbox" },
	{ keys = [ "g", "b" ],		command = "cd -" },
	{ keys = [ "?" ],		command = "help" },

	{ keys = [ "t", "a" ],  command = "spawn addtag %s" },
	{ keys = [ "t", "r" ],  command = "spawn rmtag %s" },
	{ keys = [ "i" ],       command = "spawn sxiv -t %s" },
	{ keys = [ "e", "s" ],  command = "shell unzip_delete_and_sxiv %s" },
	{ keys = [ "e", "v" ],  command = "shell nvim %s" },
	{ keys = [ "e", "w" ],  command = "shell setbg %s" },
]
